...
export function MobileSidebar({ isOpen, onClose, currentScreen, onNavigate }: MobileSidebarProps) {
  const menuItems = [
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside 
        className="fixed left-0 top-0 h-full w-64 border-r z-50 transition-transform duration-300 overflow-y-auto"
        style={{ 
